...
<body>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-lg-9">
                            <div class="blog-content" data-animation="fadeInUp" data-delay="100ms">
                                <h2 data-animation="fadeInUp" data-delay="400ms">Selamat datang</h2>
                                <p data-animation="fadeInUp" data-delay="700ms">AYO BURUAN BELI JANGAN DI LIAT AJA</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-slide bg-img bg-overlay" style="background-image: url(assets/egames/img/bg-img/2.jpg);">
                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-lg-9">
                            <div class="blog-content" data-animation="fadeInUp" data-delay="100ms">
                                <h2 data-animation="fadeInUp" data-delay="400ms">HARGA GILAA</h2>
                                <p data-animation="fadeInUp" data-delay="700ms">GILA KAPAN LAGI ADA HARGA SEGINI</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="blog-area section-gap">
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="col-md-12 pb-40 header-text text-center">
							<h1 class="pb-10">Game Terbaru</h1>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 blog-left">
							<div class="thumb">
								<img class="img-fluid" src="/XIRPL2/blog-master/admin/artikel/img/<?php echo $data['foto'] ?>" alt="" style="width:400px; height:400px;">
							</div>
                            <BR>
							<div class="detais">
								<ul class="tags">
        ...
        <section class="latest-articles-area section-padding-100-0 bg-img bg-pattern bg-fixed" style="background-image: url(/XIRPL2/blog-master/assets/egames/img/bg-img/5.jpg);">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="mb-100">
                        <!-- Title -->
                        <h2 class="section-title mb-70 wow fadeInUp" data-wow-delay="100ms">Penjelasan</h2>
                        <?php
                        $blog = new Frontend();
                        foreach ($blog->index() as $data) {
                        ?>
                        ...
                        <div class="single-articles-area style-2 d-flex flex-wrap mb-30 wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <div class="article-content">
                                <a href="single-post.html" class="post-title"><?php echo $data['judul']?></a>
                                <div class="post-meta">
                                    <a href="#" class="post-date"><?php echo $data['nama_kategori']?></a>
                                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="single-widget-area add-widget wow fadeInUp" data-wow-delay="300ms">
                        <a href="#"><img src="/XIRPL2/blog-master/assets/egames/img/bg-img/add.png" alt="" style="height:1500px;"></a>
                        <!-- Side Img -->
                        <img src="/XIRPL2/blog-master/assets/egames/img/bg-img/side-img.png" class="side-img" alt="">
                    </div>
                </div>
            </div>
        </div>
